 ...
 * 		 3. You can append the suffix "_After" to the method name<br>
 * 		 (2+3): e.g. method name in the original class: Activity#onCreate<br>
 * 		 			 method name in our class:			OurClass#onCreate_After<br>
 * 		 <br>
 ...
 * 		 <br>
 * 		 5. The arguments of the our method have to match the arguments of the original method.<br>
 * 		 5.1. As this method runs after the original method the result of the original method will be passed as first argument.<br>
 */
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.METHOD)
public @interface AfterOriginalMethod {
}
